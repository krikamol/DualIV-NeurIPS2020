...
class MLPModel(nn.Module):
    def __init__(self, input_dim, layer_widths, activation=None,
                 var=None, last_layer=None, num_out=1):
    ...
    def initialize(self):
        ...
        if self.var is None:
            ...
            print('Final Layer Gain: 1.0')
        else:
            nn.init.xavier_normal_(final_layer.weight.data, gain=self.var)
            print('Final Layer Gain: {}'.format(self.var))
